...
- [x] [Number of Good Pairs](https://leetcode.com/problems/number-of-good-pairs/) - (revise)
...
- [x] [Transpose Matrix](https://leetcode.com/problems/transpose-matrix/) - (revise)
...
- [x] [Two Sum](https://leetcode.com/problems/two-sum/) - (revise)
- [x] [Find N Unique Integers Sum up to Zero](https://leetcode.com/problems/find-n-unique-integers-sum-up-to-zero/) - (revise)
- [x] [Saddle Point In Matrix](https://leetcode.com/problems/lucky-numbers-in-a-matrix/) - (revise)
- [x] [Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) - (revise)
- [ ] [Reshape the Matrix](https://leetcode.com/problems/reshape-the-matrix/) - (revise)

### Medium
- [ ] [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) - (revise)
- [ ] [Set Matrix Zeroes](https://leetcode.com/problems/set-matrix-zeroes/) - (revise)
